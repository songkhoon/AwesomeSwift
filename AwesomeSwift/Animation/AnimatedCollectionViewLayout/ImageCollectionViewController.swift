...
class SimpleCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        titleLabel.font = UIFont.systemFont(ofSize: 100)
        titleLabel.textAlignment = .center
        addSubview(titleLabel)
        titleLabel.translatesAutoresizingMaskIntoConstraints = false
        titleLabel.centerXAnchor.constraint(equalTo: centerXAnchor).isActive = true
        titleLabel.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
        titleLabel.widthAnchor.constraint(equalToConstant: 500).isActive = true
...
class ImageCollectionViewController: UICollectionViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let dismissGesture = UISwipeGestureRecognizer(target: self, action: #selector(didSwipeDown(_:)))
    ...
    func didSwipeDown(_ sender: Any) {
